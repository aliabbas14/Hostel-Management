...
if(isset($_POST["login"]))
{
	...
	$db=mysqli_select_db($con,'hostel_managment') or die("cannot connect database");
		...
		$n=$_POST['user_name'];
		$p=$_POST['password'];
		$result =mysqli_query($con,"select * from hostel where id='".$n."'");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">hostel Login </h2>
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									<label for=""  class="text-uppercase text-sm">Hostel Id</label>
									<input type="text" name="user_name" placeholder="Email"  class="form-control mb">
