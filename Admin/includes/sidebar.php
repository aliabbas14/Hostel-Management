...
<li><a href="search.php"><i class="fa fa-file-o"></i>Display Hostel</a></li>
<li><a href="display_student.php"><i class="fa fa-file-o"></i>Display Student</a></li>
<li><a href="display_chart.php"><i class="fa fa-file-o"></i>Data Presentation</a></li>
...
<?php } ?>
				...
				<li><a href="sort.php"><i class="fa fa-user"></i>Allocate Seats</a></li>
				<li><a href="sort_2.php"><i class="fa fa-user"></i>Hostel Status</a></li>
